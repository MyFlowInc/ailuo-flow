...
const HistoryInfoModal: React.FC<any> = (props: any) => {
	const { isShowInfoModal, setIsShowInfoModal, project: projectInfo } = props;
	const [showDstColumns, setShowDstColumns] = useState(
	...
	const { setIsShowApproveModal, freshData } = useContext(
